...
export const metadata = {
    title: 'Política de Privacidade | Simone Belle',
    description: 'Política de Privacidade da Clínica de Terapia Simone Belle.',
};
                    ...
                    <div className="space-y-8 text-slate-600 leading-relaxed">
                        ...
                        <div>
                            ...
                            <ul className="list-disc pl-5 space-y-2">
                                <li><strong>Controladora:</strong> Terapeuta Simone Belle</li>
